...
export class Scroller extends PIXI.Container {
  ...
  shiftViewportX(value) {
    ...
    let [ minSpeed, maxSpeed ] = [ Settings.ScrollSpeed * game.multiplier, Settings.MaxScrollSpeed * game.multiplier ];
  ...
  setScrollSpeed(speed) {
    if (this.isGameOver) {
      ...
      this._speed = Math.max(0, this.gameOverSpeed -= this.gameOverSpeedStep * game.multiplier);
      return;
    }
    this._speed = speed;
  }
